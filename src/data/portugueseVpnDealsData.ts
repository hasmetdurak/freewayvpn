export interface PortugueseVpnDeal {
  id: number;
  name: string;
  logo: string;
  price: number;
...
export const portugueseVpnDealsData: PortugueseVpnDeal[] = [
  {
    id: 1,
    name: "NordVPN",
    ...
    discount: 71,
    rating: 9.6,
    feature: "Servidores mais rápidos + VPN dupla",
  ...
  },
  {
    ...
    discount: 82,
    rating: 9.4,
    feature: "Dispositivos ilimitados",
  ...
  },
  {
    ...
    discount: 48,
    rating: 9.5,
    feature: "Melhor capacidade de streaming",
  ...
  },
  {
    ...
    discount: 83,
    rating: 9.2,
    feature: "Servidores especializados",
  ...
  },
  {
    ...
    discount: 81,
    rating: 9.0,
    feature: "6500+ servidores ao redor do mundo",
  ...
  },
  {
    ...
    discount: 50,
    rating: 9.1,
    feature: "Proteção de dados suíços",
  ...
  },
  {
    ...
    discount: 64,
    rating: 8.8,
    feature: "Infraestrutura de servidores própria",
