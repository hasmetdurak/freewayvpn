export interface FrenchVpnDeal {
  id: number;
  name: string;
  logo: string;
  price: number;
...
export const frenchVpnDealsData: FrenchVpnDeal[] = [
  {
    id: 1,
    name: "NordVPN",
    ...
    discount: 71,
    rating: 9.6,
    feature: "Serveurs les plus rapides + Double VPN",
  ...
  },
  {
    ...
    discount: 48,
    rating: 9.5,
    feature: "Meilleure capacité de streaming",
  ...
  },
  {
    ...
    discount: 81,
    rating: 9.0,
    feature: "6500+ serveurs dans le monde",
  ...
  },
  {
    ...
    discount: 50,
    rating: 9.1,
    feature: "Protection des données suisses",
  ...
  },
  {
    ...
    discount: 64,
    rating: 8.8,
    feature: "Infrastructure de serveurs propriétaire",
