export interface SpanishVpnDeal {
  id: number;
  name: string;
  logo: string;
  price: number;
...
export const spanishVpnDealsData: SpanishVpnDeal[] = [
  {
    id: 1,
    name: "NordVPN",
    ...
    discount: 71,
    rating: 9.6,
    feature: "Servidores más rápidos + VPN doble",
  ...
  },
  {
    ...
    discount: 48,
    rating: 9.5,
    feature: "Mejor capacidad de streaming",
  ...
  },
  {
    ...
    discount: 81,
    rating: 9.0,
    feature: "6500+ servidores en todo el mundo",
  ...
  },
  {
    ...
    discount: 50,
    rating: 9.1,
    feature: "Protección de datos suizos",
  ...
  },
  {
    ...
    discount: 64,
    rating: 8.8,
    feature: "Infraestructura de servidores propia",
