...
export default function QuizPage() {
  ...
  if (results) {
    return (
      <>
        <Helmet>
          <title>{t('quiz.metaTitle') || 'VPN Recommendation Quiz - Find Your Perfect VPN'} | BestVPN.digital</title>
          <meta name="description" content={t('quiz.metaDescription') || 'Take our smart VPN quiz to get personalized recommendations based on your needs.'} />
        </Helmet>
              ...
              <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl shadow-xl p-6 mb-8 text-white">
                ...
                <form onSubmit={handleEmailSubmit} className="flex gap-2">
                  <input
                    ...
                    placeholder={t('quiz.emailPlaceholder') || 'your.email@example.com'}
                ...
                >
                  ...
                  <div className="p-8">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        ...
                        <div className="inline-flex items-center gap-2 bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-bold">
                          <span>{t('quiz.matchScore') || 'Match Score'}:</span>
                    ...
                    <div className="bg-blue-50 rounded-xl p-4 mb-4">
                      <h4 className="font-bold text-gray-900 mb-3">{t('quiz.keyFeatures') || 'Key Features'}:</h4>
                      ...
                      <div className="mb-4">
                        <div className="flex items-center gap-2">
                          <div className="flex-1 bg-gradient-to-r from-yellow-100 to-orange-100 border-2 border-dashed border-orange-400 rounded-lg px-4 py-3">
                            <div className="text-xs text-gray-600 mb-1">{t('quiz.exclusiveCoupon') || 'Exclusive Coupon'}</div>
                    ...
                    >
                      <span className="flex items-center justify-center gap-2">
                        {t('quiz.getThisDeal') || `Get ${result.provider} Now`}
  ...
  return (
    <>
      <Helmet>
        <title>{t('quiz.metaTitle') || 'VPN Recommendation Quiz'} | BestVPN.digital</title>
        <meta name="description" content={t('quiz.metaDescription') || 'Find your perfect VPN in 60 seconds'} />
      </Helmet>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex justify-between text-sm text-gray-600 mb-2">
              <span>{t('quiz.question') || 'Question'} {currentStep + 1} / {quizQuestions.length}</span>
