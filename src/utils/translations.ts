...
export const faqTranslations: AllTranslations = {
  ...
  de: {
    ...
    'contact.emailSupport': 'Sähköpostituki',
    'contact.phoneSupport': 'Puhelintuki',
    'contact.office': 'Toimisto',
    'contact.privacyFirst': 'Yksityisyys ensin',
    'contact.privacyText': 'Kunnioitamme yksityisyyttäsi. Kaikki tämän lomakkeen kautta lähetetyt tiedot on salattu ja käsitelty tiukan yksityisyyskäytäntömme mukaisesti. Emme koskaan jaa tietojasi kolmansien osapuolien kanssa.',
    'contact.sendMessage': 'Lähetä meille viesti',
    'contact.messageSent': 'Viesti lähetetty onnistuneesti!',
    'contact.messageResponse': 'Vastaamme 24 tunnin kuluessa.',
    'contact.verifyHuman': 'Vahvista, että olet ihminen ennen lähettämistä.',
    'contact.fullName': 'Koko nimi',
    'contact.emailAddress': 'Sähköpostiosoite',
    'contact.subject': 'Aihe',
    'contact.message': 'Viesti',
    'contact.selectSubject': 'Valitse aihe',
    'contact.generalInquiry': 'Yleinen kysely',
    'contact.vpnRecommendation': 'VPN-suosituspyyntö',
    'contact.technicalSupport': 'Tekninen tuki',
    'contact.partnershipInquiry': 'Kumppanuuskysely',
    'contact.pressMedia': 'Lehdistö ja media',
    'contact.feedbackSuggestions': 'Palaute ja ehdotukset',
    'contact.messagePlaceholder': 'Kuvaile kysymyksesi tai miten voimme auttaa...',
    'contact.notRobot': 'En ole robotti ja hyväksyn',
    'contact.privacyPolicy': 'Yksityisyyskäytäntö',
    'contact.termsOfService': 'Käyttöehdot',
    'contact.sending': 'Lähetetään...',
    'contact.sendMessageButton': 'Lähetä viesti',
    'contact.faqTitle': 'Usein kysytyt kysymykset',
    'contact.faqSubtitle': 'Nopeat vastaukset yleisiin kysymyksiin ennen yhteydenottoa',
    'contact.faq1Title': 'Kuinka valita oikea VPN?',
    'contact.faq1Text': 'Harkitse pääasiallisia tarpeitasi: suoratoisto, yksityisyys, nopeus tai hinta. Vertailutyökalumme auttaa sinua suodattamaan VPN:it ominaisuuksien mukaan, ja asiantuntijamme voivat antaa henkilökohtaisia suosituksia.',
    'contact.faq2Title': 'Ovatko arvostelusi puolueettomia?',
    'contact.faq2Text': 'Kyllä, arvostelumme perustuvat tiukkoihin testeihin ja todellisiin käyttäjäkokemuksiin. Vaikka ansaitsemme affiliate-palkkioita, tämä ei vaikuta sijoituksiimme tai suosituksiimme.',
    'contact.faq3Title': 'Tarjoatteko teknistä tukea?',
    'contact.faq3Text': 'Tarjoamme ohjeita VPN-valintaan ja yleisiä asennusneuvoja. Teknisissä ongelmissa tiettyjen VPN-palveluiden kanssa ohjaamme sinut sopivan palveluntarjoajan tukitiimiin.',
    'contact.faq4Title': 'Voitteko auttaa yritys-VPN:issä?',
    'contact.faq4Text': 'Ehdottomasti! Meillä on asiantuntemusta yritys-VPN-ratkaisuissa ja voimme auttaa sinua löytämään palveluita, jotka täyttävät yrityksesi turvallisuus-, mittakaava- ja vaatimustenmukaisuusvaatimukset.',
  ...
  hi: {
    ...
    'contact.privacyFirst': 'गोपनीयता पहले',
    'contact.privacyText': 'हम आपकी गोपनीयता का सम्मान करते हैं। इस फॉर्म के माध्यम से भेजी गई सभी जानकारी एन्क्रिप्टेड है और हमारी सख्त गोपनीयता नीति के अनुसार संसाधित की जाती है। हम कभी भी आपका डेटा तीसरे पक्ष के साथ साझा नहीं करते।',
    'contact.sendMessage': 'हमें संदेश भेजें',
    'contact.messageSent': 'संदेश सफलतापूर्वक भेजा गया!',
    'contact.messageResponse': 'हम 24 घंटे के भीतर आपको जवाब देंगे।',
    'contact.verifyHuman': 'कृपया भेजने से पहले सत्यापित करें कि आप मानव हैं।',
    ...
    'contact.vpnRecommendation': 'VPN सिफारिश अनुरोध',
    'contact.technicalSupport': 'तकनीकी सहायता',
    'contact.partnershipInquiry': 'साझेदारी पूछताछ',
    'contact.pressMedia': 'प्रेस और मीडिया',
    'contact.feedbackSuggestions': 'फीडबैक और सुझाव',
    'contact.messagePlaceholder': 'कृपया अपना प्रश्न या हम कैसे मदद कर सकते हैं वर्णन करें...',
    'contact.notRobot': 'मैं एक रोबोट नहीं हूं और मैं स्वीकार करता हूं',
    'contact.privacyPolicy': 'गोपनीयता नीति',
    'contact.termsOfService': 'सेवा की शर्तें',
    'contact.sending': 'भेजा जा रहा है...',
    'contact.sendMessageButton': 'संदेश भेजें',
    'contact.faqTitle': 'अक्सर पूछे जाने वाले प्रश्न',
    'contact.faqSubtitle': 'हमसे संपर्क करने से पहले सामान्य प्रश्नों के त्वरित उत्तर',
    'contact.faq1Title': 'सही VPN कैसे चुनें?',
    'contact.faq1Text': 'अपनी मुख्य आवश्यकताओं पर विचार करें: स्ट्रीमिंग, गोपनीयता, गति या मूल्य। हमारा तुलना उपकरण आपको सुविधाओं के अनुसार VPN को फ़िल्टर करने में मदद करता है, और हमारे विशेषज्ञ व्यक्तिगत सिफारिशें प्रदान कर सकते हैं।',
    'contact.faq2Title': 'क्या आपकी समीक्षाएं निष्पक्ष हैं?',
    'contact.faq2Text': 'हां, हमारी समीक्षाएं कठोर परीक्षण और वास्तविक उपयोगकर्ता अनुभवों पर आधारित हैं। हालांकि हम एफिलिएट कमीशन कमाते हैं, यह हमारी रैंकिंग या सिफारिशों को प्रभावित नहीं करता।',
    'contact.faq3Title': 'क्या आप तकनीकी सहायता प्रदान करते हैं?',
    'contact.faq3Text': 'हम VPN चुनने और सामान्य सेटअप सलाह पर मार्गदर्शन प्रदान करते हैं। विशिष्ट VPN सेवाओं के साथ तकनीकी समस्याओं के लिए, हम आपको प्रदाता की उपयुक्त सहायता टीम के पास भेजेंगे।',
    'contact.faq4Title': 'क्या आप व्यावसायिक VPN के साथ मदद कर सकते हैं?',
    'contact.faq4Text': 'बिल्कुल! हमारे पास उद्यम VPN समाधानों में विशेषज्ञता है और हम आपको ऐसी सेवाएं खोजने में मदद कर सकते हैं जो आपके व्यवसाय की सुरक्षा, पैमाने और अनुपालन आवश्यकताओं को पूरा करती हैं।',
    'contact.followUs': 'हमें फॉलो करें',
    'contact.newsletter': 'न्यूज़लेटर',
    'contact.twitter': 'Twitter',
    'contact.facebook': 'Facebook',
    'contact.linkedin': 'LinkedIn',
  ...
  ar: {
    ...
    'contact.privacyFirst': 'الخصوصية أولاً',
    'contact.privacyText': 'نحن نحترم خصوصيتك. جميع المعلومات المرسلة من خلال هذا النموذج مشفرة ومعالجة وفقاً لسياسة الخصوصية الصارمة. نحن لا نشارك بياناتك مع أطراف ثالثة أبداً.',
    'contact.sendMessage': 'أرسل لنا رسالة',
    'contact.messageSent': 'تم إرسال الرسالة بنجاح!',
    'contact.messageResponse': 'سنجيب عليك خلال 24 ساعة.',
    'contact.verifyHuman': 'يرجى التحقق من أنك إنسان قبل الإرسال.',
    ...
    'contact.vpnRecommendation': 'طلب توصية VPN',
    'contact.technicalSupport': 'الدعم التقني',
    'contact.partnershipInquiry': 'استفسار الشراكة',
    'contact.pressMedia': 'الصحافة والإعلام',
    'contact.feedbackSuggestions': 'الملاحظات والاقتراحات',
    'contact.messagePlaceholder': 'يرجى وصف سؤالك أو كيف يمكننا مساعدتك...',
    'contact.notRobot': 'أنا لست روبوتاً وأوافق على',
    'contact.privacyPolicy': 'سياسة الخصوصية',
    'contact.termsOfService': 'شروط الخدمة',
    'contact.sending': 'جاري الإرسال...',
    'contact.sendMessageButton': 'إرسال الرسالة',
    'contact.faqTitle': 'الأسئلة الشائعة',
    'contact.faqSubtitle': 'إجابات سريعة للأسئلة الشائعة قبل التواصل معنا',
    'contact.faq1Title': 'كيف أختار VPN المناسب؟',
    'contact.faq1Text': 'فكر في احتياجاتك الأساسية: البث، الخصوصية، السرعة أو السعر. أداة المقارنة لدينا تساعدك في تصفية VPN حسب الميزات، وخبراؤنا يمكنهم تقديم توصيات مخصصة.',
    'contact.faq2Title': 'هل مراجعاتك غير متحيزة؟',
    'contact.faq2Text': 'نعم، مراجعاتنا مبنية على اختبارات صارمة وتجارب مستخدمين حقيقية. رغم أننا نكسب عمولات تابعة، هذا لا يؤثر على ترتيباتنا أو توصياتنا.',
    'contact.faq3Title': 'هل تقدمون الدعم التقني؟',
    'contact.faq3Text': 'نحن نقدم إرشادات حول اختيار VPN ونصائح إعداد عامة. للمشاكل التقنية مع خدمات VPN محددة، سنوجهك لفريق الدعم المناسب للمزود.',
    'contact.faq4Title': 'هل يمكنكم المساعدة مع VPN الأعمال؟',
    'contact.faq4Text': 'بالطبع! لدينا خبرة في حلول VPN المؤسسية ويمكننا مساعدتك في العثور على خدمات تلبي متطلبات الأمان والحجم والامتثال لعملك.',
  ...
  tl: {
    ...
    'contact.getInTouch': 'Makipag-ugnayan sa amin',
    'contact.emailSupport': 'Suporta sa email',
    'contact.phoneSupport': 'Suporta sa telepono',
    'contact.office': 'Opisina',
    'contact.privacyFirst': 'Privacy muna',
    'contact.privacyText': 'Iginagalang namin ang inyong privacy. Lahat ng impormasyon na ipinadala sa pamamagitan ng form na ito ay naka-encrypt at pinoproseso ayon sa aming mahigpit na patakaran sa privacy. Hindi namin kailanman ibinabahagi ang inyong data sa mga third party.',
    'contact.sendMessage': 'Magpadala ng mensahe sa amin',
    'contact.messageSent': 'Matagumpay na naipadala ang mensahe!',
    'contact.messageResponse': 'Sasagutin namin kayo sa loob ng 24 na oras.',
    'contact.verifyHuman': 'Pakiverify na tao kayo bago magpadala.',
    'contact.fullName': 'Buong pangalan',
    'contact.emailAddress': 'Email address',
    'contact.subject': 'Paksa',
    'contact.message': 'Mensahe',
    'contact.selectSubject': 'Pumili ng paksa',
    'contact.generalInquiry': 'Pangkalahatang tanong',
    'contact.vpnRecommendation': 'Hiling sa rekomendasyon ng VPN',
    'contact.technicalSupport': 'Teknikal na suporta',
    'contact.partnershipInquiry': 'Tanong sa partnership',
    'contact.pressMedia': 'Press at media',
    'contact.feedbackSuggestions': 'Feedback at mga mungkahi',
    'contact.messagePlaceholder': 'Pakilarawan ang inyong tanong o kung paano namin kayo matutulungan...',
    'contact.notRobot': 'Hindi ako robot at sumasang-ayon ako sa',
    'contact.privacyPolicy': 'Patakaran sa privacy',
    'contact.termsOfService': 'Mga tuntunin ng serbisyo',
    'contact.sending': 'Nagpapadala...',
    'contact.sendMessageButton': 'Magpadala ng mensahe',
    'contact.faqTitle': 'Mga madalas na tanong',
    'contact.faqSubtitle': 'Mabilis na mga sagot sa mga karaniwang tanong bago makipag-ugnayan sa amin',
    'contact.faq1Title': 'Paano pumili ng tamang VPN?',
    'contact.faq1Text': 'Isaalang-alang ang inyong mga pangunahing pangangailangan: streaming, privacy, bilis o presyo. Ang aming tool sa paghahambing ay tumutulong sa inyo na i-filter ang mga VPN ayon sa mga feature, at ang aming mga eksperto ay maaaring magbigay ng mga personalisadong rekomendasyon.',
    'contact.faq2Title': 'Walang kinikilingan ba ang inyong mga review?',
    'contact.faq2Text': 'Oo, ang aming mga review ay batay sa mahigpit na pagsubok at tunay na mga karanasan ng user. Bagaman kumikita kami ng mga affiliate commission, hindi ito nakakaapekto sa aming mga ranking o rekomendasyon.',
    'contact.faq3Title': 'Nag-aalok ba kayo ng teknikal na suporta?',
    'contact.faq3Text': 'Nagbibigay kami ng gabay sa pagpili ng VPN at mga pangkalahatang payo sa setup. Para sa mga teknikal na problema sa mga partikular na VPN service, ididirekta namin kayo sa naaangkop na support team ng provider.',
    'contact.faq4Title': 'Maaari ba ninyong tulungan sa mga business VPN?',
    'contact.faq4Text': 'Syempre! Mayroon kaming kadalubhasaan sa mga enterprise VPN solution at maaari naming tulungan kayo na makahanap ng mga serbisyo na tumutugon sa mga pangangailangan sa seguridad, sukat, at pagsunod ng inyong negosyo.',
  ...
  id: {
    ...
    'contact.phoneSupport': 'Dukungan telepon',
    'contact.office': 'Kantor',
    'contact.privacyFirst': 'Privasi pertama',
    'contact.privacyText': 'Kami menghormati privasi Anda. Semua informasi yang dikirim melalui formulir ini dienkripsi dan ditangani sesuai dengan kebijakan privasi ketat kami. Kami tidak pernah membagikan data Anda dengan pihak ketiga.',
    'contact.sendMessage': 'Kirim pesan kepada kami',
    'contact.messageSent': 'Pesan berhasil dikirim!',
    'contact.messageResponse': 'Kami akan membalas dalam 24 jam.',
    'contact.verifyHuman': 'Silakan verifikasi bahwa Anda adalah manusia sebelum mengirim.',
    ...
    'contact.vpnRecommendation': 'Permintaan rekomendasi VPN',
    'contact.technicalSupport': 'Dukungan teknis',
    'contact.partnershipInquiry': 'Pertanyaan kemitraan',
    'contact.pressMedia': 'Pers dan media',
    'contact.feedbackSuggestions': 'Umpan balik dan saran',
    'contact.messagePlaceholder': 'Silakan jelaskan pertanyaan Anda atau bagaimana kami dapat membantu...',
    'contact.notRobot': 'Saya bukan robot dan saya setuju dengan',
    'contact.privacyPolicy': 'Kebijakan privasi',
    'contact.termsOfService': 'Ketentuan layanan',
    'contact.sending': 'Mengirim...',
    'contact.sendMessageButton': 'Kirim pesan',
    'contact.faqTitle': 'Pertanyaan yang sering diajukan',
    'contact.faqSubtitle': 'Jawaban cepat untuk pertanyaan umum sebelum menghubungi kami',
    'contact.faq1Title': 'Bagaimana cara memilih VPN yang tepat?',
    'contact.faq1Text': 'Pertimbangkan kebutuhan utama Anda: streaming, privasi, kecepatan atau harga. Alat perbandingan kami membantu Anda memfilter VPN berdasarkan fitur, dan pakar kami dapat memberikan rekomendasi yang dipersonalisasi.',
    'contact.faq2Title': 'Apakah ulasan Anda tidak bias?',
    'contact.faq2Text': 'Ya, ulasan kami didasarkan pada pengujian ketat dan pengalaman pengguna nyata. Meskipun kami mendapat komisi afiliasi, ini tidak mempengaruhi peringkat atau rekomendasi kami.',
    'contact.faq3Title': 'Apakah Anda menawarkan dukungan teknis?',
    'contact.faq3Text': 'Kami memberikan panduan tentang pemilihan VPN dan saran pengaturan umum. Untuk masalah teknis dengan layanan VPN tertentu, kami akan mengarahkan Anda ke tim dukungan yang sesuai dari penyedia.',
    'contact.faq4Title': 'Bisakah Anda membantu dengan VPN bisnis?',
    'contact.faq4Text': 'Tentu saja! Kami memiliki keahlian dalam solusi VPN perusahaan dan dapat membantu Anda menemukan layanan yang memenuhi persyaratan keamanan, skala, dan kepatuhan bisnis Anda.',
  ...
  fa: {
    ...
    'contact.getInTouch': 'با ما تماس بگیرید',
    'contact.emailSupport': 'پشتیبانی ایمیل',
    'contact.phoneSupport': 'پشتیبانی تلفنی',
    'contact.office': 'دفتر',
    'contact.privacyFirst': 'حریم خصوصی اول',
    'contact.privacyText': 'ما حریم خصوصی شما را محترم می‌شماریم. تمام اطلاعات ارسال شده از طریق این فرم رمزگذاری شده و طبق سیاست حریم خصوصی سختگیرانه ما پردازش می‌شود. ما هرگز داده‌های شما را با اشخاص ثالث به اشتراک نمی‌گذاریم.',
    'contact.sendMessage': 'پیام برای ما ارسال کنید',
    'contact.messageSent': 'پیام با موفقیت ارسال شد!',
    'contact.messageResponse': 'ما ظرف 24 ساعت پاسخ خواهیم داد.',
    'contact.verifyHuman': 'لطفاً قبل از ارسال تأیید کنید که انسان هستید.',
    'contact.fullName': 'نام کامل',
    'contact.emailAddress': 'آدرس ایمیل',
    'contact.subject': 'موضوع',
    'contact.message': 'پیام',
    'contact.selectSubject': 'انتخاب موضوع',
    'contact.generalInquiry': 'سوال عمومی',
    'contact.vpnRecommendation': 'درخواست توصیه VPN',
    'contact.technicalSupport': 'پشتیبانی فنی',
    'contact.partnershipInquiry': 'سوال شراکت',
    'contact.pressMedia': 'رسانه و مطبوعات',
    'contact.feedbackSuggestions': 'بازخورد و پیشنهادات',
    'contact.messagePlaceholder': 'لطفاً سوال خود را توضیح دهید یا چگونه می‌توانیم کمک کنیم...',
    'contact.notRobot': 'من ربات نیستم و با',
    'contact.privacyPolicy': 'سیاست حریم خصوصی',
    'contact.termsOfService': 'شرایط خدمات',
    'contact.sending': 'در حال ارسال...',
    'contact.sendMessageButton': 'ارسال پیام',
    'contact.faqTitle': 'سوالات متداول',
    'contact.faqSubtitle': 'پاسخ‌های سریع به سوالات رایج قبل از تماس با ما',
    'contact.faq1Title': 'چگونه VPN مناسب را انتخاب کنم؟',
    'contact.faq1Text': 'نیازهای اصلی خود را در نظر بگیرید: استریمینگ، حریم خصوصی، سرعت یا قیمت. ابزار مقایسه ما به شما کمک می‌کند VPN‌ها را بر اساس ویژگی‌ها فیلتر کنید، و متخصصان ما می‌توانند توصیه‌های شخصی‌سازی شده ارائه دهند.',
    'contact.faq2Title': 'آیا بررسی‌های شما بی‌طرفانه است؟',
    'contact.faq2Text': 'بله، بررسی‌های ما بر اساس آزمایش‌های سختگیرانه و تجربیات واقعی کاربران است. اگرچه ما کمیسیون وابسته کسب می‌کنیم، این بر رتبه‌بندی یا توصیه‌های ما تأثیر نمی‌گذارد.',
    'contact.faq3Title': 'آیا پشتیبانی فنی ارائه می‌دهید؟',
    'contact.faq3Text': 'ما راهنمایی در مورد انتخاب VPN و توصیه‌های تنظیمات عمومی ارائه می‌دهیم. برای مشکلات فنی با خدمات VPN خاص، شما را به تیم پشتیبانی مناسب ارائه‌دهنده هدایت می‌کنیم.',
    'contact.faq4Title': 'آیا می‌توانید با VPN‌های تجاری کمک کنید؟',
    'contact.faq4Text': 'البته! ما در راه‌حل‌های VPN سازمانی تخصص داریم و می‌توانیم به شما کمک کنیم خدمات مناسب با نیازهای امنیتی، مقیاس و انطباق کسب‌وکار شما پیدا کنید.',
    'contact.followUs': 'ما را دنبال کنید',
    'contact.newsletter': 'خبرنامه',
    'contact.twitter': 'Twitter',
    'contact.facebook': 'Facebook',
    'contact.linkedin': 'LinkedIn',
  ...
  pl: {
    ...
    'contact.getInTouch': 'Skontaktuj się z nami',
    'contact.emailSupport': 'Wsparcie e-mail',
    'contact.phoneSupport': 'Wsparcie telefoniczne',
    'contact.office': 'Biuro',
    'contact.privacyFirst': 'Prywatność na pierwszym miejscu',
    'contact.privacyText': 'Szanujemy Twoją prywatność. Wszystkie informacje wysłane za pośrednictwem tego formularza są szyfrowane i przetwarzane zgodnie z naszą rygorystyczną polityką prywatności. Nigdy nie udostępniamy Twoich danych stronom trzecim.',
    'contact.sendMessage': 'Wyślij nam wiadomość',
    'contact.messageSent': 'Wiadomość wysłana pomyślnie!',
    'contact.messageResponse': 'Odpowiemy w ciągu 24 godzin.',
    'contact.verifyHuman': 'Proszę potwierdzić, że jesteś człowiekiem przed wysłaniem.',
    'contact.fullName': 'Pełne imię i nazwisko',
    'contact.emailAddress': 'Adres e-mail',
    'contact.subject': 'Temat',
    'contact.message': 'Wiadomość',
    'contact.selectSubject': 'Wybierz temat',
    'contact.generalInquiry': 'Ogólne zapytanie',
    'contact.vpnRecommendation': 'Prośba o rekomendację VPN',
    'contact.technicalSupport': 'Wsparcie techniczne',
    'contact.partnershipInquiry': 'Zapytanie o partnerstwo',
    'contact.pressMedia': 'Prasa i media',
    'contact.feedbackSuggestions': 'Opinie i sugestie',
    'contact.messagePlaceholder': 'Proszę opisać swoje pytanie lub jak możemy pomóc...',
    'contact.notRobot': 'Nie jestem robotem i akceptuję',
    'contact.privacyPolicy': 'Politykę prywatności',
    'contact.termsOfService': 'Warunki usługi',
    'contact.sending': 'Wysyłanie...',
    'contact.sendMessageButton': 'Wyślij wiadomość',
    'contact.faqTitle': 'Często zadawane pytania',
    'contact.faqSubtitle': 'Szybkie odpowiedzi na częste pytania przed kontaktem z nami',
    'contact.faq1Title': 'Jak wybrać odpowiedni VPN?',
    'contact.faq1Text': 'Rozważ swoje główne potrzeby: streaming, prywatność, prędkość lub cena. Nasze narzędzie porównawcze pomoże Ci filtrować VPN według funkcji, a nasi eksperci mogą dostarczyć spersonalizowane rekomendacje.',
    'contact.faq2Title': 'Czy Twoje recenzje są bezstronne?',
    'contact.faq2Text': 'Tak, nasze recenzje opierają się na rygorystycznych testach i prawdziwych doświadczeniach użytkowników. Chociaż zarabiamy prowizje partnerskie, nie wpływa to na nasze rankingi ani rekomendacje.',
    'contact.faq3Title': 'Czy oferujecie wsparcie techniczne?',
    'contact.faq3Text': 'Zapewniamy wskazówki dotyczące wyboru VPN i ogólne porady dotyczące konfiguracji. W przypadku problemów technicznych z określonymi usługami VPN skierujemy Cię do odpowiedniego zespołu wsparcia dostawcy.',
    'contact.faq4Title': 'Czy możecie pomóc z VPN dla firm?',
    'contact.faq4Text': 'Absolutnie! Mamy doświadczenie w rozwiązaniach VPN dla przedsiębiorstw i możemy pomóc Ci znaleźć usługi, które spełniają wymagania bezpieczeństwa, skali i zgodności Twojej firmy.',
  ...
  pt: {
    ...
    'contact.emailSupport': 'Suporte por e-mail',
    'contact.phoneSupport': 'Suporte telefônico',
    'contact.office': 'Escritório',
    'contact.privacyFirst': 'Privacidade primeiro',
    'contact.privacyText': 'Respeitamos sua privacidade. Todas as informações enviadas através deste formulário são criptografadas e tratadas de acordo com nossa rigorosa política de privacidade. Nunca compartilhamos seus dados com terceiros.',
    'contact.sendMessage': 'Envie-nos uma mensagem',
    'contact.messageSent': 'Mensagem enviada com sucesso!',
    'contact.messageResponse': 'Responderemos em 24 horas.',
    'contact.verifyHuman': 'Por favor, verifique se você é humano antes de enviar.',
    'contact.fullName': 'Nome completo',
    'contact.emailAddress': 'Endereço de e-mail',
    'contact.subject': 'Assunto',
    'contact.message': 'Mensagem',
    'contact.selectSubject': 'Selecionar um assunto',
    'contact.generalInquiry': 'Consulta geral',
    'contact.vpnRecommendation': 'Solicitação de recomendação VPN',
    'contact.technicalSupport': 'Suporte técnico',
    'contact.partnershipInquiry': 'Consulta de parceria',
    'contact.pressMedia': 'Imprensa e mídia',
    'contact.feedbackSuggestions': 'Feedback e sugestões',
    'contact.messagePlaceholder': 'Por favor, descreva sua pergunta ou como podemos ajudá-lo...',
    'contact.notRobot': 'Não sou um robô e aceito a',
    'contact.privacyPolicy': 'Política de privacidade',
    'contact.termsOfService': 'Termos de serviço',
    'contact.sending': 'Enviando...',
    'contact.sendMessageButton': 'Enviar mensagem',
    'contact.faqTitle': 'Perguntas frequentes',
    'contact.faqSubtitle': 'Respostas rápidas para perguntas comuns antes de entrar em contato',
    'contact.faq1Title': 'Como escolher o VPN correto?',
    'contact.faq1Text': 'Considere suas necessidades principais: streaming, privacidade, velocidade ou preço. Nossa ferramenta de comparação ajuda você a filtrar VPNs por recursos, e nossos especialistas podem fornecer recomendações personalizadas.',
    'contact.faq2Title': 'Suas análises são imparciais?',
    'contact.faq2Text': 'Sim, nossas análises são baseadas em testes rigorosos e experiências reais de usuários. Embora ganhemos comissões de afiliados, isso não influencia nossas classificações ou recomendações.',
    'contact.faq3Title': 'Vocês oferecem suporte técnico?',
    'contact.faq3Text': 'Fornecemos orientação sobre escolha de VPNs e conselhos gerais de configuração. Para problemas técnicos com serviços VPN específicos, direcionaremos você para a equipe de suporte apropriada do provedor.',
    'contact.faq4Title': 'Podem ajudar com VPNs empresariais?',
    'contact.faq4Text': 'Absolutamente! Temos experiência em soluções VPN empresariais e podemos ajudá-lo a encontrar serviços que atendam aos requisitos de segurança, escala e conformidade da sua empresa.',
  ...
  es: {
    ...
    'contact.emailSupport': 'Soporte por correo',
    'contact.phoneSupport': 'Soporte telefónico',
    'contact.office': 'Oficina',
    'contact.privacyFirst': 'Privacidad primero',
    'contact.privacyText': 'Respetamos tu privacidad. Toda la información enviada a través de este formulario está encriptada y se maneja según nuestra estricta política de privacidad. Nunca compartimos tus datos con terceros.',
    'contact.sendMessage': 'Envíanos un mensaje',
    'contact.messageSent': '¡Mensaje enviado con éxito!',
    'contact.messageResponse': 'Te responderemos dentro de 24 horas.',
    'contact.verifyHuman': 'Por favor verifica que eres humano antes de enviar.',
    'contact.fullName': 'Nombre completo',
    'contact.emailAddress': 'Dirección de correo',
    'contact.subject': 'Asunto',
    'contact.message': 'Mensaje',
    'contact.selectSubject': 'Seleccionar un asunto',
    'contact.generalInquiry': 'Consulta general',
    'contact.vpnRecommendation': 'Solicitud de recomendación VPN',
    'contact.technicalSupport': 'Soporte técnico',
    'contact.partnershipInquiry': 'Consulta de asociación',
    'contact.pressMedia': 'Prensa y medios',
    'contact.feedbackSuggestions': 'Comentarios y sugerencias',
    'contact.messagePlaceholder': 'Por favor describe tu pregunta o cómo podemos ayudarte...',
    'contact.notRobot': 'No soy un robot y acepto la',
    ...
    'contact.faqSubtitle': 'Respuestas rápidas a preguntas comunes antes de contactarnos',
    'contact.faq1Title': '¿Cómo elijo el VPN correcto?',
    'contact.faq1Text': 'Considera tus necesidades principales: streaming, privacidad, velocidad o precio. Nuestra herramienta de comparación te ayuda a filtrar VPNs por características, y nuestros expertos pueden proporcionar recomendaciones personalizadas.',
    'contact.faq2Title': '¿Son imparciales tus reseñas?',
    'contact.faq2Text': 'Sí, nuestras reseñas se basan en pruebas rigurosas y experiencias reales de usuarios. Aunque ganamos comisiones de afiliados, esto no influye en nuestras clasificaciones o recomendaciones.',
    'contact.faq3Title': '¿Ofrecen soporte técnico?',
    'contact.faq3Text': 'Proporcionamos orientación sobre la elección de VPNs y consejos generales de configuración. Para problemas técnicos con servicios VPN específicos, te dirigiremos al equipo de soporte apropiado del proveedor.',
    'contact.faq4Title': '¿Pueden ayudar con VPNs empresariales?',
    'contact.faq4Text': '¡Absolutamente! Tenemos experiencia en soluciones VPN empresariales y podemos ayudarte a encontrar servicios que cumplan con los requisitos de seguridad, escala y cumplimiento de tu empresa.',
    'contact.followUs': 'Síguenos',
    'contact.newsletter': 'Boletín',
    'contact.twitter': 'Twitter',
    'contact.facebook': 'Facebook',
    'contact.linkedin': 'LinkedIn',
  ...
  th: {
    ...
    'contact.emailSupport': 'การสนับสนุนอีเมล',
    'contact.phoneSupport': 'การสนับสนุนโทรศัพท์',
    'contact.office': 'สำนักงาน',
    'contact.privacyFirst': 'ความเป็นส่วนตัวก่อน',
    'contact.privacyText': 'เราเคารพความเป็นส่วนตัวของคุณ ข้อมูลทั้งหมดที่ส่งผ่านแบบฟอร์มนี้จะถูกเข้ารหัสและจัดการตามนโยบายความเป็นส่วนตัวที่เข้มงวดของเรา เราไม่เคยแบ่งปันข้อมูลของคุณกับบุคคลที่สาม',
    'contact.sendMessage': 'ส่งข้อความถึงเรา',
    'contact.messageSent': 'ส่งข้อความสำเร็จ!',
    'contact.messageResponse': 'เราจะตอบกลับภายใน 24 ชั่วโมง',
    'contact.verifyHuman': 'กรุณายืนยันว่าคุณเป็นมนุษย์ก่อนส่ง',
    'contact.fullName': 'ชื่อเต็ม',
    ...
    'contact.vpnRecommendation': 'คำขอแนะนำ VPN',
    'contact.technicalSupport': 'การสนับสนุนทางเทคนิค',
    'contact.partnershipInquiry': 'คำถามหุ้นส่วน',
    'contact.pressMedia': 'สื่อมวลชน',
    'contact.feedbackSuggestions': 'ข้อเสนอแนะและข้อเสนอแนะ',
    'contact.messagePlaceholder': 'กรุณาอธิบายคำถามของคุณหรือเราจะช่วยได้อย่างไร...',
    'contact.notRobot': 'ฉันไม่ใช่หุ่นยนต์และฉันยอมรับ',
    'contact.privacyPolicy': 'นโยบายความเป็นส่วนตัว',
    'contact.termsOfService': 'เงื่อนไขการให้บริการ',
    'contact.sending': 'กำลังส่ง...',
    'contact.sendMessageButton': 'ส่งข้อความ',
    'contact.faqTitle': 'คำถามที่พบบ่อย',
    'contact.faqSubtitle': 'คำตอบด่วนสำหรับคำถามทั่วไปก่อนติดต่อเรา',
    'contact.faq1Title': 'จะเลือก VPN ที่เหมาะสมได้อย่างไร?',
    'contact.faq1Text': 'พิจารณาความต้องการหลักของคุณ: สตรีมมิ่ง ความเป็นส่วนตัว ความเร็ว หรือราคา เครื่องมือเปรียบเทียบของเราช่วยให้คุณกรอง VPN ตามคุณสมบัติ และผู้เชี่ยวชาญของเราสามารถให้คำแนะนำส่วนตัว',
    'contact.faq2Title': 'บทวิจารณ์ของคุณเป็นกลางหรือไม่?',
    'contact.faq2Text': 'ใช่ บทวิจารณ์ของเราอิงจากการทดสอบที่เข้มงวดและประสบการณ์ผู้ใช้จริง แม้ว่าเราจะได้รับค่าคอมมิชชั่นพันธมิตร แต่สิ่งนี้ไม่ส่งผลต่อการจัดอันดับหรือคำแนะนำของเรา',
    'contact.faq3Title': 'คุณให้การสนับสนุนทางเทคนิคหรือไม่?',
    'contact.faq3Text': 'เราให้คำแนะนำเกี่ยวกับการเลือก VPN และคำแนะนำการตั้งค่าทั่วไป สำหรับปัญหาทางเทคนิคกับบริการ VPN เฉพาะ เราจะแนะนำคุณไปยังทีมสนับสนุนที่เหมาะสมของผู้ให้บริการ',
    'contact.faq4Title': 'คุณสามารถช่วยกับ VPN ธุรกิจได้หรือไม่?',
    'contact.faq4Text': 'แน่นอน! เรามีความเชี่ยวชาญในโซลูชัน VPN องค์กรและสามารถช่วยคุณค้นหาบริการที่ตรงตามความต้องการด้านความปลอดภัย ขนาด และการปฏิบัติตามข้อกำหนดของธุรกิจของคุณ',
    'contact.followUs': 'ติดตามเรา',
    'contact.newsletter': 'จดหมายข่าว',
    'contact.twitter': 'Twitter',
    'contact.facebook': 'Facebook',
    'contact.linkedin': 'LinkedIn',
  ...
  vi: {
    ...
    'contact.getInTouch': 'Liên hệ với chúng tôi',
    'contact.emailSupport': 'Hỗ trợ email',
    'contact.phoneSupport': 'Hỗ trợ điện thoại',
    'contact.office': 'Văn phòng',
    'contact.privacyFirst': 'Quyền riêng tư trước tiên',
    'contact.privacyText': 'Chúng tôi tôn trọng quyền riêng tư của bạn. Tất cả thông tin được gửi qua biểu mẫu này đều được mã hóa và xử lý theo chính sách quyền riêng tư nghiêm ngặt của chúng tôi. Chúng tôi không bao giờ chia sẻ dữ liệu của bạn với bên thứ ba.',
    'contact.sendMessage': 'Gửi tin nhắn cho chúng tôi',
    'contact.messageSent': 'Tin nhắn đã được gửi thành công!',
    'contact.messageResponse': 'Chúng tôi sẽ phản hồi trong vòng 24 giờ.',
    'contact.verifyHuman': 'Vui lòng xác minh rằng bạn là con người trước khi gửi.',
    ...
    'contact.vpnRecommendation': 'Yêu cầu tư vấn VPN',
    'contact.technicalSupport': 'Hỗ trợ kỹ thuật',
    'contact.partnershipInquiry': 'Câu hỏi đối tác',
    'contact.pressMedia': 'Báo chí và truyền thông',
    'contact.feedbackSuggestions': 'Phản hồi và gợi ý',
    'contact.messagePlaceholder': 'Vui lòng mô tả câu hỏi của bạn hoặc cách chúng tôi có thể giúp đỡ...',
    'contact.notRobot': 'Tôi không phải là robot và tôi đồng ý với',
    'contact.privacyPolicy': 'Chính sách quyền riêng tư',
    'contact.termsOfService': 'Điều khoản dịch vụ',
    'contact.sending': 'Đang gửi...',
    'contact.sendMessageButton': 'Gửi tin nhắn',
    'contact.faqTitle': 'Câu hỏi thường gặp',
    'contact.faqSubtitle': 'Câu trả lời nhanh cho các câu hỏi phổ biến trước khi liên hệ với chúng tôi',
    'contact.faq1Title': 'Làm thế nào để chọn VPN phù hợp?',
    'contact.faq1Text': 'Hãy xem xét nhu cầu chính của bạn: streaming, quyền riêng tư, tốc độ hoặc giá cả. Công cụ so sánh của chúng tôi giúp bạn lọc VPN theo tính năng, và các chuyên gia của chúng tôi có thể cung cấp tư vấn cá nhân hóa.',
    'contact.faq2Title': 'Đánh giá của bạn có khách quan không?',
    'contact.faq2Text': 'Có, đánh giá của chúng tôi dựa trên các bài kiểm tra nghiêm ngặt và trải nghiệm thực tế của người dùng. Mặc dù chúng tôi kiếm được hoa hồng liên kết, điều này không ảnh hưởng đến xếp hạng hoặc tư vấn của chúng tôi.',
    'contact.faq3Title': 'Bạn có cung cấp hỗ trợ kỹ thuật không?',
    'contact.faq3Text': 'Chúng tôi cung cấp hướng dẫn về việc chọn VPN và lời khuyên thiết lập chung. Đối với các vấn đề kỹ thuật với các dịch vụ VPN cụ thể, chúng tôi sẽ hướng dẫn bạn đến nhóm hỗ trợ phù hợp của nhà cung cấp.',
    'contact.faq4Title': 'Bạn có thể giúp với VPN doanh nghiệp không?',
    'contact.faq4Text': 'Tất nhiên! Chúng tôi có chuyên môn trong các giải pháp VPN doanh nghiệp và có thể giúp bạn tìm các dịch vụ đáp ứng các yêu cầu bảo mật, quy mô và tuân thủ của doanh nghiệp bạn.',
    'contact.followUs': 'Theo dõi chúng tôi',
    'contact.newsletter': 'Bản tin',
    'contact.twitter': 'Twitter',
    'contact.facebook': 'Facebook',
    'contact.linkedin': 'LinkedIn',
  ...
  it: {
    ...
    'contactSubtitle': 'Mettiti in contatto con i nostri esperti VPN per raccomandazioni personalizzate e supporto',
    'contact.getInTouch': 'Mettiti in contatto',
    'contact.emailSupport': 'Supporto via email',
    'contact.phoneSupport': 'Supporto telefonico',
    'contact.office': 'Ufficio',
    'contact.privacyFirst': 'Privacy prima di tutto',
    'contact.privacyText': 'Rispettiamo la tua privacy. Tutte le informazioni inviate tramite questo modulo sono crittografate e gestite secondo la nostra rigorosa politica sulla privacy. Non condividiamo mai i tuoi dati con terze parti.',
    'contact.sendMessage': 'Inviaci un messaggio',
    'contact.messageSent': 'Messaggio inviato con successo!',
    'contact.messageResponse': 'Ti risponderemo entro 24 ore.',
    'contact.verifyHuman': 'Si prega di verificare di essere umano prima di inviare.',
    'contact.fullName': 'Nome completo',
    ...
    'contact.vpnRecommendation': 'Richiesta di raccomandazione VPN',
    'contact.technicalSupport': 'Supporto tecnico',
    'contact.partnershipInquiry': 'Richiesta di partnership',
    'contact.pressMedia': 'Stampa e media',
    'contact.feedbackSuggestions': 'Feedback e suggerimenti',
    'contact.messagePlaceholder': 'Si prega di descrivere la tua domanda o come possiamo aiutarti...',
    'contact.notRobot': 'Non sono un robot e accetto la',
    'contact.privacyPolicy': 'Politica sulla privacy',
    'contact.termsOfService': 'Termini di servizio',
    'contact.sending': 'Invio in corso...',
    'contact.sendMessageButton': 'Invia messaggio',
    'contact.faqTitle': 'Domande frequenti',
    'contact.faqSubtitle': 'Risposte rapide alle domande comuni prima di contattarci',
    'contact.faq1Title': 'Come scegliere il VPN giusto?',
    'contact.faq1Text': 'Considera le tue esigenze principali: streaming, privacy, velocità o prezzo. Il nostro strumento di confronto ti aiuta a filtrare i VPN per funzionalità, e i nostri esperti possono fornire raccomandazioni personalizzate.',
    'contact.faq2Title': 'Le tue recensioni sono imparziali?',
    'contact.faq2Text': 'Sì, le nostre recensioni si basano su test rigorosi ed esperienze reali degli utenti. Anche se guadagniamo commissioni di affiliazione, questo non influenza le nostre classifiche o raccomandazioni.',
    'contact.faq3Title': 'Offrite supporto tecnico?',
    'contact.faq3Text': 'Forniamo orientamento sulla scelta dei VPN e consigli generali di configurazione. Per problemi tecnici con servizi VPN specifici, ti indirizzeremo al team di supporto appropriato del provider.',
    'contact.faq4Title': 'Potete aiutare con i VPN aziendali?',
    'contact.faq4Text': 'Assolutamente! Abbiamo esperienza nelle soluzioni VPN aziendali e possiamo aiutarti a trovare servizi che soddisfino i requisiti di sicurezza, scala e conformità della tua azienda.',
  ...
  ru: {
    ...
    'contact.phoneSupport': 'Телефонная поддержка',
    'contact.office': 'Офис',
    'contact.privacyFirst': 'Конфиденциальность прежде всего',
    'contact.privacyText': 'Мы уважаем вашу конфиденциальность. Вся информация, отправленная через эту форму, зашифрована и обрабатывается в соответствии с нашей строгой политикой конфиденциальности. Мы никогда не передаем ваши данные третьим лицам.',
    'contact.sendMessage': 'Отправить нам сообщение',
    'contact.messageSent': 'Сообщение успешно отправлено!',
    'contact.messageResponse': 'Мы ответим вам в течение 24 часов.',
    'contact.verifyHuman': 'Пожалуйста, подтвердите, что вы человек, перед отправкой.',
    'contact.fullName': 'Полное имя',
    'contact.emailAddress': 'Адрес электронной почты',
    'contact.subject': 'Тема',
    'contact.message': 'Сообщение',
    'contact.selectSubject': 'Выберите тему',
    'contact.generalInquiry': 'Общий запрос',
    'contact.vpnRecommendation': 'Запрос рекомендации VPN',
    'contact.technicalSupport': 'Техническая поддержка',
    'contact.partnershipInquiry': 'Запрос о партнерстве',
    'contact.pressMedia': 'Пресса и СМИ',
    'contact.feedbackSuggestions': 'Отзывы и предложения',
    'contact.messagePlaceholder': 'Пожалуйста, опишите ваш вопрос или как мы можем помочь...',
    'contact.notRobot': 'Я не робот и принимаю',
    'contact.privacyPolicy': 'Политику конфиденциальности',
    'contact.termsOfService': 'Условия обслуживания',
    'contact.sending': 'Отправка...',
    'contact.sendMessageButton': 'Отправить сообщение',
    'contact.faqTitle': 'Часто задаваемые вопросы',
    'contact.faqSubtitle': 'Быстрые ответы на распространенные вопросы перед обращением к нам',
    'contact.faq1Title': 'Как выбрать правильный VPN?',
    'contact.faq1Text': 'Учитывайте ваши основные потребности: стриминг, конфиденциальность, скорость или цена. Наш инструмент сравнения помогает фильтровать VPN по функциям, а наши эксперты могут предоставить персонализированные рекомендации.',
    'contact.faq2Title': 'Ваши обзоры беспристрастны?',
    'contact.faq2Text': 'Да, наши обзоры основаны на тщательном тестировании и реальном опыте пользователей. Хотя мы получаем партнерские комиссии, это не влияет на наши рейтинги или рекомендации.',
    'contact.faq3Title': 'Предлагаете ли вы техническую поддержку?',
    'contact.faq3Text': 'Мы предоставляем руководство по выбору VPN и общие советы по настройке. При технических проблемах с конкретными VPN-сервисами мы направим вас к соответствующей команде поддержки провайдера.',
    'contact.faq4Title': 'Можете ли вы помочь с корпоративными VPN?',
    'contact.faq4Text': 'Абсолютно! У нас есть опыт в корпоративных VPN-решениях, и мы можем помочь вам найти сервисы, которые соответствуют требованиям безопасности, масштабируемости и соответствия вашего бизнеса.',
  ...
  zh: {
    ...
    // Contact Page
    'contactTitle': '联系我们',
    'contactSubtitle': '联系我们的VPN专家获取个性化推荐和支持',
    'contact.getInTouch': '联系我们',
    'contact.emailSupport': '邮件支持',
    'contact.phoneSupport': '电话支持',
    'contact.office': '办公室',
    'contact.privacyFirst': '隐私优先',
    'contact.privacyText': '我们尊重您的隐私。通过此表单提交的所有信息都经过加密，并根据我们严格的隐私政策进行处理。我们从不与第三方分享您的数据。',
    'contact.sendMessage': '发送消息',
    'contact.messageSent': '消息发送成功！',
    'contact.messageResponse': '我们将在24小时内回复您。',
    'contact.verifyHuman': '请在提交前验证您是人类。',
    'contact.fullName': '全名',
    ...
    'contact.vpnRecommendation': 'VPN推荐请求',
    'contact.technicalSupport': '技术支持',
    'contact.partnershipInquiry': '合作咨询',
    'contact.pressMedia': '新闻媒体',
    'contact.feedbackSuggestions': '反馈建议',
    'contact.messagePlaceholder': '请描述您的问题或我们如何帮助您...',
    'contact.notRobot': '我不是机器人，我同意',
    'contact.privacyPolicy': '隐私政策',
    'contact.termsOfService': '服务条款',
    'contact.sending': '发送中...',
    'contact.sendMessageButton': '发送消息',
    'contact.faqTitle': '常见问题',
    'contact.faqSubtitle': '联系我们前常见问题的快速答案',
    'contact.faq1Title': '如何选择正确的VPN？',
    'contact.faq1Text': '考虑您的主要需求：流媒体、隐私、速度或价格。我们的比较工具帮助您按功能筛选VPN，我们的专家可以提供个性化推荐。',
    'contact.faq2Title': '您的评论是否公正？',
    'contact.faq2Text': '是的，我们的评论基于严格的测试和真实的用户体验。虽然我们获得联盟佣金，但这不影响我们的排名或推荐。',
    'contact.faq3Title': '您提供技术支持吗？',
    'contact.faq3Text': '我们提供VPN选择指导和一般设置建议。对于特定VPN服务的技术问题，我们会将您引导到相应提供商的支持团队。',
    'contact.faq4Title': '您能帮助企业VPN吗？',
    'contact.faq4Text': '当然！我们在企业VPN解决方案方面有专业知识，可以帮助您找到满足您企业安全、规模和合规要求的服务。',
